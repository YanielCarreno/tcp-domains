...
(:init
       ...
       (visible postoffice house10loc0)
        ...
        (door-open house2loc0)
        (door-open house3loc0)
        (door-open house4loc0)
        (door-open house5loc0)
        (door-open house6loc0)
        (door-open house7loc0)
        (door-open house8loc0)
        (door-open house9loc0)
        (door-open house10loc0)
        (door-open house11loc0)
        (door-open house12loc0)
        (door-open house13loc0)
        (door-open house14loc0)
        (door-open house15loc0)
        (door-open house16loc0)
        (door-open house17loc0)
        (door-open house18loc0)
        (door-open house19loc0)
)
...
(:knowledge-updates
  ...
  (house0loc0 (door-closed house0loc0) ((not (door-closed house0loc0)) => (door-open house0loc0)) )
  (house1loc0 (door-closed house1loc0) ((not (door-closed house1loc0)) => (door-open house1loc0)) )
)
