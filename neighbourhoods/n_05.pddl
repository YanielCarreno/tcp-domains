...
(:constraints
       (and (preference sb1 (sometime-before (parcel_delivered postman0 house10loc1) (parcel_delivered postman0 house0loc1)))
            ...
            (preference sa3 (sometime-after (parcel_delivered postman0 house13loc1) (parcel_delivered postman0 house10loc1)))
            (preference sa4 (sometime-after (parcel_delivered postman0 house13loc1) (parcel_delivered postman0 house12loc1)))
            (preference sa5 (sometime-after (parcel_delivered postman0 house13loc1) (parcel_delivered postman0 house11loc1)))
